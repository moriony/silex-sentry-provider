...
class SentryServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Application $app)
    {
        $app[self::SENTRY] = $app->share(function () use($app) {
            $options = $app[SentryServiceProvider::SENTRY_OPTIONS];
    ...
    {
        $app[self::SENTRY_OPTIONS] = array_merge(SentryServiceProvider::$defaultOptions, $app[SentryServiceProvider::SENTRY_OPTIONS]);
    }
}
